...
//	// 전체 리스트 출력
//	public RequestWriting selectListBoard(Connection conn) throws SQLException {
//
//		PreparedStatement pstmt = null;
//		ResultSet rs = null;
//		RequestWriting rw=null;
//
//		String sql = "SELECT * FROM project.request_list";
//
//		try {
//
...
//				
//				rw.setReq_idx( rs.getInt(1));
//				rw.setReq_writer(rs.getInt(2));
//				rw.setReq_title(rs.getString(3)); // 게시글 제목
//				rw.setReq_helper(rs.getInt(4)); // 수행자
//				rw.setReq_price(rs.getInt(5)); // 가격
//				rw.setReq_regdate( rs.getDate(6)); // 등록날자
//				rw.setReq_term(rs.getDate(7)); // 렌탈기간
//				rw.setReq_loc(rs.getString(8)); // 지역
//				rw.setReq_text( rs.getString(9)); // 상세내용
//				rw.setReq_latitude(rs.getDouble(10));// 위도
//				rw.setReq_longitud(rs.getDouble(11));// 경도
//				rw.setReq_readcnt(rs.getInt(12)); // 조회수
//				rw.setReq_status(rs.getInt(13)); // 현재상태
//				rw.setReq_img(rs.getString(14)); // 사진
//				
//				
//				
//			}
